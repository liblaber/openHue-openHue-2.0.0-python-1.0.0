...
class ResourceGetType(Enum):
    ...
    def list():
        ...
        :rtype: list
        """
        return list(map(lambda x: x.value, ResourceGetType._member_map_.values()))
...
class ResourceGet(BaseModel):
    ...
    :type type_: ResourceGetType, optional
    ...
    def __init__(
        self,
        type_: ResourceGetType = None,
        id_: str = None,
        id_v1: str = None,
        owner: ResourceIdentifier = None,
    ):
        if type_ is not None:
            self.type_ = self._enum_matching(type_, ResourceGetType.list(), "type_")
        if id_ is not None:
